            ...
            <div className="overflow-hidden py-4 relative" style={{ backgroundColor: '#563D33', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', paddingLeft: 'calc(50vw - 50%)', paddingRight: 'calc(50vw - 50%)' }}>
              ...
              <div className="p-4 md:p-8 relative z-10">
                ...
                <div className="flex justify-center mb-8">
                  <video src="/step3-gif1.mp4" autoPlay muted loop playsInline className="w-full max-w-4xl rounded-2xl" />
                </div>
                <p className="text-amber-100/80 mb-6 text-sm md:text-base">
                ...
                <div className="flex justify-center">
                  <video src="/step3-gif2.mp4" autoPlay muted loop playsInline className="w-full max-w-4xl rounded-2xl" />
                </div>
              </div>
              ...
              <div className="p-4 md:p-8 relative z-10">
                ...
                <div className="flex justify-center">
                  <video src="/step3-gif3.mp4" autoPlay muted loop playsInline className="w-full max-w-4xl rounded-2xl" />
                </div>
              </div>
              ...
              <div className="p-4 md:p-8 relative z-10">
                ...
                <div className="flex justify-center">
                  <video src="/step5-gif4.mp4" autoPlay muted loop playsInline className="w-full max-w-4xl rounded-2xl" />
                </div>
              </div>
            </div>
