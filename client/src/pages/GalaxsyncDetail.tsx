          ...
          >
            ...
            <div className="overflow-hidden py-4 relative" style={{ backgroundColor: '#563D33', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)', paddingLeft: 'calc(50vw - 50%)', paddingRight: 'calc(50vw - 50%)' }}>
              ...
              <div className="p-8 relative z-10">
                ...
                <div className="flex justify-center mb-8 overflow-hidden rounded-2xl">
                  <img src="/step3-gif1.gif" alt="Dunhuang Planet Gameplay" className="w-full" style={{ margin: '-2.5%', width: '105%', maxWidth: '105%' }} />
                </div>
                <p className="text-amber-100/80 mb-6">
                ...
                <div className="flex justify-center overflow-hidden rounded-2xl">
                  <img src="/step3-gif2.gif" alt="Cosmic Mentor Interaction" className="w-full" style={{ margin: '-2.5%', width: '105%', maxWidth: '105%' }} />
                </div>
              </div>
              ...
              <div className="p-8 relative z-10">
                ...
                <div className="flex justify-center overflow-hidden rounded-2xl">
                  <img src="/step3-gif3.gif" alt="Biometric Guidance" className="w-full" style={{ margin: '-2.5%', width: '105%', maxWidth: '105%' }} />
                </div>
              </div>
              ...
              <div className="p-8 relative z-10">
                ...
                <div className="flex justify-center overflow-hidden rounded-2xl">
                  <img src="/step5-gif4.gif" alt="Story Echo Rewards" className="w-full" style={{ margin: '-2.5%', width: '105%', maxWidth: '105%' }} />
                </div>
              </div>
            </div>
